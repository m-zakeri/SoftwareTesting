...
%%
% Zakeri Ph.D. Thesis Glossary (Universal glassory)
%%
...
\newword{code-related-task}{code related task}{وظیفه مرتبط با کد}{وظایف مرتبط با کد}
...
\newword{testability}{testability}{آزمون‌پذیری}{قابلیتِ‌ آزمون}

\newword{clean-code}{clean code}{‌کدِ پاک}{کدهای پاک}
\newword{refactoring}{refactoring}{بازآرایی}{بازآرایی‌ها}
\newword{refactoring-operation}{refactoring operation}{عمل بازآرایی}{عملیات بازآرایی}
...
\newword{quality-attribute}{quality attribute}{صفت کیفی}{صفات کیفی}
...
\newword{heuristic}{heuristic}{اکتشافی}{اکتشافی}
...
\newword{dependency-injection}{dependency-injection}{تزریقِ وابستگی}{تزریق وابستگی}
...
\newword{feature-envy}{feature envy}{حسادت ویژگی}{حسادت ویژگی‌ها}
...
\newword{flexibility}{flexibility}{انعطاف‌پذیری}{قابلیت انعطاف}
...
\newword{code-smell}{code smell}{بوی کد}{بوهای کد}
\newword{design-smell}{design smell}{بوی طراحی}{بوهای طراحی}
...
\newword{submetric}{submetric}{زیرمتریک}{زیرمتریک‌ها}
\newword{lexical-metric}{lexical metric}{متریک لغوی}{متریک‌های لغوی}
...
\newword{artifacts-similarity}{artifacts similarity}{تشابه مصنوعات}{مشابهت مصنوعات}
\newword{euclidean-distance}{Euclidean-distance}{فاصله اقلیدسی}{فاصله‌های اقلیدسی}
\newword{cosine-similarity}{cosine similarity}{شباهت کسینوسی}{شباهت‌های کسینوسی}
\newword{manhattan-distance}{Manhattan distance}{فاصله منهتن}{فاصله‌های منهتن}
...
\newword{coverageability}{coverageability}{پوشش‌پذیری}{پوشش‌پذیری}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Chapter2
\newword{effectiveness}{effectiveness}{اثربخشی}{اثربخشی}
\newword{efficiency}{efficiency}{کارایی}{کارایی}
\newword{grid-search}{grid search}{جست‌وجوی توری}{جست‌وجوی توری}
\newword{cross-validation}{cross-validation}{اعتبارسنجی متقابل}{اعتبارسنجی متقابل}
\newword{permutation-importance}{permutation importance}{اهمیت جایگشت}{اهمیت جایگشت}
\newword{program-transformation}{program transformation}{تبدیل برنامه}{تبدیل برنامه}
\newword{stereotype}{stereotypes}{کلیشه}{کلیشه‌ها}

\newword{knee-point}{knee point}{نقطه‌زانو}{نقاط زانو}
...
\newword{statement-coverage}{statement-coverage}{پوشش دستور}{پوشش دستورات}
\newword{node-coverage}{node coverage}{پوشش گره}{پوشش گره}
\newword{mutation-coverage}{mutation-coverage}{پوشش جهش}{پوشش جهش}
\newword{mutation-score}{mutation-score}{امتیاز جهش}{امتیاز جهش}
\newword{line-coverage}{line coverage}{پوشش خط}{پوشش خطوط}
...
\newword{software-pattern}{software pattern}{الگوی نرم‌افزاری}{الگوهای نرم‌افزاری}
...
\newword{distributed representation}{distributed representation}{بازنمایی توزیع شده}{بازنمایی‌های توزیع شده}
\newword{many-to- many-relationship}{many-to- many relationship}{رابطه چند به چند}{رابطه چند به چند}
...
\newword{entity}{entity}{موجودیت}{موجودیت‌ها}
\newword{abstraction-level}{abstraction-level}{سطح انتزاع}{سطوح انتزاع}
...
\newword{shallow-learning}{shallow learning}{یادگیری سطحی}{یادگیری سطحی}
...
%% Chapter3 
\newword{code-clone}{code clone}{کد ‌تکراری}{کدهای تکراری}
\newword{snowballing}{snowballing}{گلوله برفی}{گلوله برفی}
\newword{branch-coverage-expectation}{branch-coverage-expectation}{امید پوشش شاخه}{انتظار پوشش شاخه}
\newword{complexity-of-interaction}{complexity of interaction}{پیچیدگیِ تعامل}{پیچیدگیِ تعامل}
\newword{semantic-folding}{semantic folding}{ تاب معنایی}{ تاب معنایی}
...
\newword{recall}{recall}{بیادآوری}{بیادآوری}
...
\newword{end-to-end}{end to end}{انتهابه‌انتها}{انتهابه‌انتها}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Chapter 4
\newword{influential-test-data}{influential test data}{داده آزمون مؤثر}{داده‌های آزمون مؤثر}
\newword{minimized-test-suite}{minimized test suite}{مجموعه آزمون‌کمینه}{مجموعه‌های آزمون کمینه}
\newword{accessor-method}{accessor method}{متد دسترسی دهنده}{متدهای دسترسی دهنده}
\newword{mutator-method}{mutator method}{متد تغییر دهنده}{متدهای تغییر دهنده}
\newword{transfer-learning}{transfer learning}{یادگیری انتقالی}{یادگیری انتقالی}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Chapter 6
\newword{batch-refactoring}{batch refactoring}{بازآرایی دسته‌ای}{بازآرایی‌های دسته‌ای}

%% Chapter 7
\newword{elitism}{elitism}{نُخبه‌گرایی}{نُخبه‌گرایی}
\newword{pareto-dominant}{pareto dominant}{تسلط پَرِتو}{تسلط پَرِتو}
\newword{pareto-non-dominated}{pareto non-dominated}{پَرِتوی غیر مغلوب}{پَرِتوی غیر مغلوب}
\newword{pareto-front}{pareto front}{جبهه پَرِتو}{جبهه پَرِتو}
\newword{refactoring-propagation}{refactoring propagation}{انتشار بازآرایی}{انتشار بازآرایی‌ها}
\newword{semantic-action}{semantic action}{کُنش معنایی}{کُنش‌های معنایی}
\newword{semantic-rule}{semantic rule}{قاعده معنایی}{قواعد معنایی}
\newword{listener}{listener}{شنونده}{شنونده}
...
\newword{testability-gain}{testability gain}{بهره آزمون‌پذیری}{بهره آزمون‌پذیری}
\newword{quality-gain}{quality gain}{بهره کیفی}{بهره کیفی}
\newword{tolerance}{tolerance}{تحمل}{تحمل}
\newword{bonferroni-correction}{Bonferroni correction}{تصحیح بُنفرونی}{تصحیح بُنفرونی}
...
%% Chapter 9
\newword{white-box-compiler}{white-box compiler}{کامپایلرجعبه سفید}{کامپایلرهای جعبه سفید}
\newword{micro-refactoring}{micro-refactoring}{ریز بازآرایی}{ریز بازآرایی‌ها}
\newword{pipe-and-filter}{pipe and filter}{لوله و صافی}{لوله و صافی}
\newword{monolithic}{conolithic}{یکپارچه}{یکپارچه}
\newword{front-end}{front end}{جبهه جلویی}{جبهه‌های جلویی}
\newword{legacy-system}{legacy system}{سیستم قدیمی}{سیستم‌های قدیمی}
\newword{developed-system}{developed system}{سیستم توسعه  داده شده}{سیستم‌های توسعه داده شده}
